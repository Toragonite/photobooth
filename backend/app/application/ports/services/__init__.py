...
from app.application.ports.services.image_processor_port import ImageProcessorPort
...
from app.application.ports.services.system_service_port import SystemServicePort
